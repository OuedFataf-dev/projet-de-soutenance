...
<template>
  <div id="webcrumbs">
      <div data-id="xSSI" class="bg-gray-100 min-h-screen">
           <div data-id="a5ND" class="flex"> 
            ...
            <div class="w-[220px] bg-gray-900 text-white min-h-screen">
  <!-- Logo et Titre -->
    ...
    <div
     ...
     class="mt-8 px-4 py-2 flex items-center space-x-2 text-red-400 hover:bg-red-800 hover:text-white cursor-pointer">
      <span class="material-symbols-outlined">logout</span>
                   ...
                   <div  v-if="!showGestionUtilisateurs" data-id="tc87" class="flex-1 -mt-160 ml-50 "> 
                     <div data-id="7Ks-" class="bg-white border-b flex justify-between items-center p-2">
                       <div data-id="S9Vx" class="flex items-center space-x-2">
                         <div data-id="j0kr" class="relative w-80 "> 
                          <input data-id="RQ2V" type="text" placeholder="Search for..." class="w-full  ml-2 py-2 border rounded-lg"/>
 ...
 <!-- titre (placeholder si pas dans l'API) -->
    ...
    <td class="py-3 px-4 text-indigo-400 hover:underline cursor-pointer">
      ...
      <span @click="deleteUser(user.id)" class="text-red-400 hover:underline cursor-pointer">
        Supprimer
      </span>
    </td>
  </tr>
