    ...
    <div class="flex gap-x-20 justify-center items-center">
      ...
      <div class="mt-10 px-30">
        <div class="font-bold text-4xl">
          Connectez-vous pour <br> continuer à apprendre
          <div class="mt-5">
            <input 
              type="text" 
              placeholder="E-mail"
            ...
            <div class="relative flex items-center justify-center w-full my-8">
              ...
              <span class="absolute bg-white px-3 font-medium text-gray-900 text-sm left-1/2 transform -translate-x-1/2 dark:text-white dark:bg-gray-900">
          ...
          <div class="py-10 mt-10 px-10 bg-gray-300 w-96 text-center">
            <p class="text-sm">
              Vous n'avez pas de compte ? 
              <a href="/register" class="text-blue-600 underline font-semibold hover:text-blue-800">S'inscrire</a>
            </p>

            <hr class="w-full my-3 h-px bg-gray-400 border-0 dark:bg-gray-700">

            <p class=""></p>
            <a href="#" class="text-blue-600 underline  text-sm font-semibold hover:text-blue-800">Connectez-vous avec votre entreprise</a>
          </div>
        </div>   
      </div>
    </div>
