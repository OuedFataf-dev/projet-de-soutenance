...
import { secondRow } from '../../data/dataBusiness'

import { firstRow } from '../../data/dataBusiness'
...
const formations = ref([
  ...
  { label: 'vente', isLink: false },
  { label: 'Gestion', route: '/web1', isLink: true },
  { label: 'Communication', isLink: false },
  { label: 'operations', isLink: false },
  { label: 'Gestions de projets', isLink: false },
  { label: 'Droites des affaires', isLink: false },
])

// Récupération dynamique selon la catégorie passée dans l'URL
onMounted(async () => {
  const category = route.params.category || 'Informatique et Logiciel'
...
<template>
  <Principale
    ...
    categoryId="Informatique et Logiciel"
    :coursesData3="cards"
    :module="module"
