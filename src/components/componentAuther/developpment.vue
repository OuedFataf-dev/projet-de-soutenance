...
const formations = ref([
  { label: 'Désign', route: '/design', isLink: true },
  { label: 'Web Développement', route: '/web', isLink: true },
  { label: 'Data Science', isLink: false },
  { label: 'Mobile Développement', route: '/devmobile', isLink: true },
...
onMounted(async () => {
  const category = route.params.category || 'Développement'
