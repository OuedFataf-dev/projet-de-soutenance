<template>
    ...
    <div class="bg-white w-full -mt-10  h-200">
    ...
    <strong>30 jours</strong>
      ...
      <div class=" border-t-2 border-gray-200 -ml-5 w-100 mt-5  bg-gray-100"></div>
        ...
        <div class="md:w-3/4 p-4">
            <p class=" hidden md:block text-gray-600 justify-end  whitespace-nowrap  ml-210 ">10 000 résultats</p>
  ...
  >
    ...
    >
      ...
      <div class="mt-6">
        ...
        <div class="hidden  md:block  border-t-2 border-gray-200 ml-50  mt-5 w-180  bg-gray-100"></div>
